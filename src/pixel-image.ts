...
interface PixelImageElement extends HTMLElement {
	...
	src: string;
	importFromImageData(imageData: ImageData, option?: PixelCanvasImportOption): void;
	import(img: ImageData | HTMLCanvasElement | HTMLImageElement | string, option?: PixelCanvasImportOption): Promise<void>;
...
((script, init) => {
	...
	function ParseImage(img: HTMLCanvasElement | HTMLImageElement | string): Promise<HTMLCanvasElement> {
	...
	((component, tagname = 'pixel-image') => {
		...
		class extends HTMLElement implements PixelImageElement {
			...
			public importFromImageData(imageData: ImageData, option?: PixelCanvasImportOption) {
			...
			public import(img: ImageData | HTMLCanvasElement | HTMLImageElement | string, option?: PixelCanvasImportOption) {
			...
			set background(value) {
				...
				const color = `#${parseInt(r).toString(16).padStart(2, '0')}${parseInt(g).toString(16).padStart(2, '0')}${
